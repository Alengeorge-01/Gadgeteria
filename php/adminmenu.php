        ...
        <header class='v-header cont' id='home'>
            <div class='video-wrap'>
                <video autoplay='true' loop='loop' muted='muted'>
                    <source src='../public/aa.mkv' type='video/mp4'>  
                </video>
            </div>
            ...
            <div class='container'> 
                <div id='myCarousel' class='carousel slide' data-ride='carousel'>
                    ...
                    <div class='carousel-inner'>
                        ...
                        <div class='item '>
                            <img src='../public/apple.png' alt='Apple Macbook'>
                            <div class='carousel-caption'>
                        ...
                        <div class='item'>
                            <img src='../public/one.jpg' alt='One Plus 6'>
                            <div class='carousel-caption'>
                                <h2>One Plus 6</h2>
            ...
            <div class='periscope'>
                <div class='container-fluid'>
                    <section id='mobile'>
                        <div class='row'>
                            <a href='mobile.php'><img src='../public/mobile.jpg' class='mob'></a>
                            <div class='mob1'>
                                <h1>Smartphones</h1>
                    ...
                    <section id='laptop'>
                        <div class='row'>
                            <a href='laptop.php'><img src='../public/lap.jpg' class='lap'></a>
                            <div class='mob1'>
                                <h1>Laptops</h1>
                    ...
                    <section id='watch'>
                        <div class='row'>
                            <a href='watch.php'><img src='../public/watches.jpg' class='mob'></a>
                            <div class='mob1'>
                                <h1>Watches</h1>
                    ...
                    <section id='tv'>
                        <div class='row'>
                            <a href='tv.php'><img src='../public/tv.jpg' class='lap'></a>
                            <div class='mob1'>
